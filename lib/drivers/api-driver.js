export default class ApiBlueprintDriver {
  /**
  ...
  */
  ...
  /**
   * Load the api service into all instances of the driver.
   * @param {ApiService} api  A configured instance of the api service.
   */
  static load(api) {
    ApiBlueprintDriver.prototype.api = api

    return ApiBlueprintDriver
  }
