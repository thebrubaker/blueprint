import { name, driverType, driver, drivers, location, embeds, hasMany, config } from './symbols'
...
export default function configureBlueprint (blueprint, options) {
  ...
  Object.defineProperty(blueprint, driver, {
    get () {
      return this[drivers][this[driverType]]
    }
  })
